        ...
        {Array.from({ length: maxIndex + 1 }, (_, i) => (
          <button
            ...
            style={{
              ...
              height: 8,
              borderRadius: 4,
              background: i === current ? P.brass : 'rgba(255,245,230,0.16)',
              border: 'none',
              cursor: 'pointer',
              padding: 0,
    ...
    <div style={{ minHeight: '100vh', background: P.linen, color: P.charcoal, fontFamily: "'Inter', system-ui, sans-serif" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .pp-ba-box { height: 280px; border: 2px dashed rgba(255,245,230,0.1); border-radius: 16px; background: rgba(255,245,230,0.03); display: flex; align-items: flex-end; justify-content: center; padding-bottom: 16px; }
        .pp-ba-label { font-family: 'IBM Plex Mono', monospace; font-size: 11px; letter-spacing: 0.14em; text-transform: uppercase; color: rgba(240,230,211,0.4); }
