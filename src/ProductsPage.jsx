    ...
    <div style={{ minHeight: '100vh', background: P.linen, color: P.charcoal, fontFamily: "'Inter', system-ui, sans-serif" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .pg-grid-wrap { max-width: 1800px; margin: 0 auto; padding: 64px 48px; }
      ...
      <div className="pg-grid-wrap">
        <div className="pg-grid">
          {PRODUCTS.map(p => (
            <Link key={p.name} to={p.href} className="pg-card" style={{ textDecoration: 'none', color: 'inherit', cursor: 'pointer' }}>
